  ...
  head: () => ({
    meta: [
      { title: "Čištění odvětrávacích šachet | Čisté šachty" },
      {
        name: "description",
        content:
          "Profesionální čištění a dezinfekce odvětrávacích šachet pro bytové domy, SVJ a správce nemovitostí po celé České republice. Bez vstupu do bytů, s fotodokumentací a protokolem.",
      },
  ...
  return (
    <SiteShell>
      <PageHero
        ...
        description="Čištění odvětrávacích šachet pomáhá udržet bytový dům v lepším technickém stavu, omezit šíření zápachu mezi byty a snížit rizika spojená se zanesením. Službu zajišťujeme pro panelové a bytové domy, SVJ, bytová družstva a správce nemovitostí po celé České republice."
