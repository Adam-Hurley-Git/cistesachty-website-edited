...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Čištění odvětrávacích šachet | Čisté šachty" },
      {
        name: "description",
        content:
          "Čištění odvětrávacích šachet pro SVJ, bytová družstva a správce nemovitostí z Břeclavska s působností po celé České republice. Bez vstupu do bytů, s fotodokumentací a protokolem.",
      },
      { property: "og:title", content: "Čištění odvětrávacích šachet | Čisté šachty" },
      {
        property: "og:description",
        content:
          "Čištění odvětrávacích šachet pro SVJ, bytová družstva a správce nemovitostí po celé České republice.",
      },
  ...
  return (
    <section className="relative flex min-h-[100svh] flex-col overflow-hidden text-cream">
      ...
      <div className="container-x relative flex flex-1 flex-col items-center justify-center py-32 text-center">
        <span className="eyebrow text-forest-light">Z Břeclavska · působnost po celé ČR</span>
        ...
        <div className="mt-14 grid w-full max-w-3xl gap-3 sm:grid-cols-3">
          {[
            ...
            {
              icon: MapPin,
              k: "Působnost po celé ČR",
              v: "Z Břeclavska vyjíždíme za bytovými domy po celé republice",
            },
          ].map((c) => (
            <div
              key={c.k}
...
function TrustBar() {
  const items = [
    { key: "Působnost po celé ČR", value: "Vyjíždíme za bytovými domy napříč republikou" },
...
function WhoWeHelp() {
  const items = [
    ...
    },
    {
      icon: MapPin,
      title: "Kde působíme",
      body: "Sídlíme v Břeclavském regionu, ale zakázky realizujeme po celé České republice.",
    },
  ];
