  ...
  head: () => ({
    meta: [
      { title: "Čištění šachet pro správce nemovitostí | Čisté šachty" },
      {
        name: "description",
        content:
          "Partner pro správce nemovitostí po celé České republice. Čištění odvětrávacích šachet s dokumentací, přehlednou komunikací a minimálním zásahem do provozu domu.",
      },
    ],
  }),
